...
SRCS += TM/tm_stm32f4_usb_vcp.c TM/tm_stm32f4_disco.c TM/tm_stm32f4_ili9341_ltdc.c TM/tm_stm32f4_spi.c 
SRCS += TM/tm_stm32f4_stmpe811.c TM/tm_stm32f4_usb_vcp.c TM/tm_stm32f4_disco.c TM/tm_stm32f4_fonts.c 
SRCS += TM/tm_stm32f4_stmpe811.c TM/tm_stm32f4_ili9341_button.c TM/tm_stm32f4_i2c.c  TM/tm_stm32f4_delay.c 
SRCS += TM/tm_stm32f4_sdram.c 
SRCS +=  TM/usb_cdc_device/usb_bsp.c TM/usb_cdc_device/usb_core.c TM/usb_cdc_device/usb_dcd.c TM/usb_cdc_device/usbd_cdc_core.c 
SRCS +=  TM/usb_cdc_device/usbd_cdc_vcp.c TM/usb_cdc_device/usb_dcd_int.c TM/usb_cdc_device/usbd_core.c TM/usb_cdc_device/usbd_desc.c 
SRCS += TM/usb_cdc_device/usbd_ioreq.c TM/usb_cdc_device/usbd_req.c TM/usb_cdc_device/usbd_usr.c
...
vpath %.c User:CMSIS:STM32F4xx_StdPeriph_Driver/src/:TM:TM/usb_cdc_device
vpath %.a STM32F4xx_StdPeriph_Driver

ROOT=$(shell pwd)

CFLAGS += -ISTM32F4xx_StdPeriph_Driver 
CFLAGS += -ISTM32F4xx_StdPeriph_Driver/inc -ITM -ITM/usb_cdc_device
